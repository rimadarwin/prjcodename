...
router.post('/', function(req, res, next) {
    ...
    User.findOne({alias: alias} ,function (err, user) {
        if (user !== null) {
            ...
            req.flash('errorMessage', 'We have already an account with email: ' + email);
            ...
            if(password === confirmPassword) {
                ...
                u.save(function (err) {
                    if (err) {
                        ...
                        req.login(u, function(err) {
                            ...
                            req.flash('successMessage', 'Welcome ' + u.name + "!");
                ...
                req.flash('registerStatus', false);
                req.flash('errorMessage', 'The confirmation password does not match the password');
                res.redirect('/register');
            }
        }
    });
